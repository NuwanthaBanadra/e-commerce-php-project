...
<head>
    ...
    <title>Purchase History | .store</title>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="name ">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <p>Price: Rs.<?php echo $product_data["price"]; ?>.00</p>

                                                    </div>
                                                </div>
                                                <div class="button">
                                                    <a class="btn bg-primary" style="border-radius: 0;" onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>);">Feedback</a>
