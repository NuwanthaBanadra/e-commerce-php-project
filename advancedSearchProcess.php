    ...
    <div class="offset-lg-1 col-12 col-lg-4">
        <div class="row justify-content-center">
            ...
            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem; border-radius: 15px;">
                ...
                <img src="<?php echo $img_data["img_path"]; ?>" style="border-radius: 20px;" />
                <div class="card-body ms-0 m-0 text-start">
                    ...
                    ?>
                        ...
                        <!-- <button class="wish" onclick='addToWatchlist(<?php echo $product_data["id"]; ?>);'>
                                        <i class="bi bi-heart-fill " id="heart<?php echo $product_data["id"]; ?>"></i>
                                    </button> -->
                    <?php
                    }
                    ?>
